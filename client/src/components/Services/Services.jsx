...
const Services = () => {
    return (
        <div className="flex flex-wrap justify-center items-center gap-2 mb-4 md:mb-8">
            <div className="flex flex-col gap-4 mr-4 justify-center items-center p-3 md:p-8 border rounded max-w-80 hover:cursor-pointer hover:shadow-xl duration-150">
            ...
            </div><div className="flex flex-col gap-4 mr-4 justify-center items-center p-3 md:p-8 border rounded max-w-80 hover:cursor-pointer hover:shadow-xl duration-150">
